...
relate_Kmer_custom_PWM <- function(k, PWM_list){
...
#fourmer_cisbpRNA <- relate_Kmer_CisBPRNA(4, "mydata/CisBPRNAdat/mm/pwms_all_motifs", "mydata/CisBPRNAdat/mm/RBP_Information_all_motifs.txt") #3min
#fivemer_cisbpRNA <- relate_Kmer_CisBPRNA(5, "mydata/CisBPRNAdat/mm/pwms_all_motifs", "mydata/CisBPRNAdat/mm/RBP_Information_all_motifs.txt") #10min
#sixmer_cisbpRNA <- relate_Kmer_CisBPRNA(6, "mydata/CisBPRNAdat/mm/pwms_all_motifs", "mydata/CisBPRNAdat/mm/RBP_Information_all_motifs.txt") #26min
#sevenmer_cisbpRNA <- relate_Kmer_CisBPRNA(7, "mydata/CisBPRNAdat/mm/pwms_all_motifs", "mydata/CisBPRNAdat/mm/RBP_Information_all_motifs.txt") #57min

#fourmer_RBNS <- relate_Kmer_RBNS(4, "mydata/RBNSdat/RBNS_PWMs") #1min
#fivemer_RBNS <- relate_Kmer_RBNS(5, "mydata/RBNSdat/RBNS_PWMs") #3min
#sixmer_RBNS <- relate_Kmer_RBNS(6, "mydata/RBNSdat/RBNS_PWMs") #8min
#sevenmer_RBNS <- relate_Kmer_RBNS(7, "mydata/RBNSdat/RBNS_PWMs") #28min

#write.table(fourmer_cisbpRNA, file = "mydata/KmerMotifRelations/fourmer_cisbpRNA.txt")
#write.table(fivemer_cisbpRNA, file = "mydata/KmerMotifRelations/fivemer_cisbpRNA.txt")
#write.table(sixmer_cisbpRNA, file = "mydata/KmerMotifRelations/sixmer_cisbpRNA.txt")
#write.table(sevenmer_cisbpRNA, file = "mydata/KmerMotifRelations/sevenmer_cisbpRNA.txt")
...
#fourmer_cisbpRNA <- read.table(file = "mydata/KmerMotifRelations/fourmer_cisbpRNA.txt")
#fivemer_cisbpRNA <- read.table(file = "mydata/KmerMotifRelations/fivemer_cisbpRNA.txt")
#sixmer_cisbpRNA <- read.table(file = "mydata/KmerMotifRelations/sixmer_cisbpRNA.txt")
#sevenmer_cisbpRNA <- read.table(file = "mydata/KmerMotifRelations/sevenmer_cisbpRNA.txt")
...
estimate_Motif_from_Kmer <- function(enriched_kmers, motif_set){
  ...
  motif_by_kmer %>% 
   ...
   dplyr:: mutate(enriched = rowSums(dplyr::select(., enriched_kmers)), 
    ...
    tidyr::separate(motif, into = c("RBP", "motif", "logo", "tile"), sep = "_", fill = "right") %>% 
    ...
    dplyr::arrange(p_adj) %>% 
    tidyr::unite(RBP, motif, logo, col = "motif", sep = "_")
