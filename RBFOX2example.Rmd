...
case <- readDNAStringSet("data/RBFOX2/DownstreamIntron.Enhanced.fasta")
ctrl <- readDNAStringSet("data/RBFOX2/DownstreamIntron.Control.fasta")
...
#RBFOX2_RBNS_compare <- RBNS_compare("data/RBNSdat/RBNS_PWMs", case, ctrl) #10.5min
...
RBFOX2_RBNS_compare <- read.table("data/RBFOX2/RBFOX2_RBNS_compare.txt") %>% as_tibble()
RBFOX2_cisbpRNA_compare <- read.table("data/RBFOX2/RBFOX2_cisbpRNA_compare.txt") %>% as_tibble()
